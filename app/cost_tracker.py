...
def calculate_cost(
    ...
    The pricing dict is shaped like data/pricing.json:
        {
          "gpt-4o": {
    ...
    Cost formula:
        cost = (prompt_tokens     / 1000 * pricing[model]["input_per_1k_tokens"])
             + (completion_tokens / 1000 * pricing[model]["output_per_1k_tokens"])
    ...
    #   2. Look up pricing[model] and read the "input_per_1k_tokens" and
    #      "output_per_1k_tokens" entries (match the keys in pricing.json exactly)
    #   3. Apply the cost formula above
