...
# Lazy client pattern (pre-implemented; uses the deployment-routing helper
# so the endpoint normalization happens regardless of how AZURE_OPENAI_ENDPOINT
# is shaped in your env).
_client = None
