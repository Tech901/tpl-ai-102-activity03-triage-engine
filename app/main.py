...
# ---------------------------------------------------------------------------
# Azure OpenAI client (pre-implemented)
# ---------------------------------------------------------------------------
# Lazy initialization keeps imports cheap and survives missing env vars during
# test collection. The endpoint is normalized via app._azure_endpoint so the
# azure-ai-inference SDK always gets a deployment-routed URL — bare resource
# endpoints (the typical org-secret form) would otherwise produce 404 at runtime.
